...
export default function DetalhesPetAdm() {
  ...
  const dadosPets: Record<string, { nome: string; especie: string; raca: string; status: string; idade: string; sexo: string; porte: string; cor: string; local: string; obs: string; foto: string }> = {
    'theo': {
      ...
      obs: 'Theo sumiu na noite de terça 05/05/2026 . Ele é dócil e possui coleira de identificação com seu nome e número de contato.',
    ...
    'gato-laranja': {
      ...
      cor: 'Laranja',
      local: 'Centro',
      obs: 'Encontrado com uma coleira azul sem identificação.',
    ...
    'caramelo': {
      ...
      cor: 'Caramelo',
      local: 'Vila Nova',
      obs: 'Visto pela última vez perto da padaria central. Ele atende pelo nome.',
    ...
    'fofinho': {
      ...
      porte: 'Grande',
      cor: 'Dourado claro',
      local: 'Bairro: Protestantes',
      obs: 'Encontrado dentro da Fatec Votorantim, dócil e com coleira',
        ...
        <div className={styles.cardDetalhes}>
          ...
          <div className={styles.colunaInfo}>
            ...
            <div className={styles.containerAcoes}>
              <div className={`${styles.btnAcao} ${styles.btnEditar}`}>
                <CustomButton type="button">
                  EDITAR FICHA
                </CustomButton>
              </div>
              <div className={`${styles.btnAcao} ${styles.btnExcluir}`}>
                <CustomButton 
                  type="button" 
                  onClick={() => setExibirModalExcluir(true)}
                >
                  OCULTAR REGISTRO
                </CustomButton>
              </div>
      ...
      <Modal show={exibirModalExcluir} onHide={() => setExibirModalExcluir(false)} centered>
        ...
        <Modal.Body style={{ padding: '40px', textAlign: 'center' }}>
          ...
          <p style={{ fontWeight: '600', color: '#475569' }}>
            Para ocultar o registro de <strong>{pet.nome}</strong>, informe o motivo da baixa para as estatísticas:
          </p>
          ...
          >
            ...
            <option value="transferido">Transferido para ONG/Protetor</option>
          ...
          <div className="d-flex gap-3 mt-4">
            <div className={`${styles.btnAcao} ${styles.btnEditar}`}>
              <CustomButton 
                type="button" 
                onClick={() => setExibirModalExcluir(false)}
              >
                VOLTAR
              </CustomButton>
            </div>
