      ...
      <aside className={`${styles.sidebar} ${isOpen ? styles.sidebarOpen : ''}`}>
        ...
        <div className={styles.conteudo}>
          ...
          <ul className={styles.listaMenu}>
            ...
            <li className={styles.itemMenu}>
              <Link href="/login" className={styles.linkMenu} onClick={onClose}>Perdi meu Pet</Link>
            </li>
            <li className={styles.itemMenu}>
              <Link href="/login" className={styles.linkMenu} onClick={onClose}>Encontrei um Pet</Link>
            </li>
            <li className={styles.itemMenu}>
